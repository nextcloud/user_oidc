...
class DiscoveryService {
	 ...
	 */
	public function obtainJWK(Provider $provider, string $tokenToDecode, bool $refresh = false): array {
		$lastJwksRefresh = $this->providerService->getSetting($provider->getId(), ProviderService::SETTING_JWKS_CACHE_TIMESTAMP);
		if ($lastJwksRefresh !== '' && !$refresh && (int)$lastJwksRefresh > time() - self::INVALIDATE_JWKS_CACHE_AFTER_SECONDS) {
