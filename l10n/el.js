OC.L10N.register(
    ...
    "There is no such OpenID Connect provider." : "Δεν υπάρχει τέτοιος πάροχος OpenID Connect.",
    "Could not reach the OpenID Connect provider." : "Δεν ήταν δυνατή η επικοινωνία με τον πάροχο OpenID Connect.",
    "The identity provider failed to authenticate the user." : "Ο πάροχος ταυτότητας απέτυχε να πιστοποιήσει τον χρήστη.",
    ...
    "Are you sure you want to delete the provider \"{providerName}\"?" : "Είστε σίγουροι ότι θέλετε να διαγράψετε τον πάροχο \"{providerName}\";",
    "Could not save ID4me state: {msg}" : "Δεν ήταν δυνατή η αποθήκευση της κατάστασης ID4me: {msg}",
    "Could not save storeLoginToken state: {msg}" : "Δεν ήταν δυνατή η αποθήκευση της κατάστασης storeLoginToken: {msg}",
    ...
    "Post logout URI" : "URI μετά την αποσύνδεση",
    "Scope" : "Εύρος",
    "Extra claims" : "Επιπλέον αξιώσεις",
    "Attribute mapping" : "Αντιστοίχιση χαρακτηριστικών",
    "Enable nested and fallback claim mappings (like \"{example}\")" : "Ενεργοποίηση ένθετων και εφεδρικών αντιστοιχίσεων claims (όπως \"{example}\")",
    ...
    "Birth date mapping" : "Αντιστοίχιση ημερομηνίας γέννησης",
    "Pronouns mapping" : "Αντιστοίχιση αντωνυμιών",
    ...
    "X (formerly Twitter) mapping" : "Αντιστοίχιση X (πρώην Twitter)",
    ...
    "By default every user will get a unique user ID that is a hashed value of the provider and user ID. This can be turned off but uniqueness of users accross multiple user backends and providers is no longer preserved then." : "Από προεπιλογή, κάθε χρήστης θα λαμβάνει μια μοναδική ταυτότητα χρήστη που είναι μια τιμή κατατεμαχισμού του παρόχου και της ταυτότητας χρήστη. Αυτό μπορεί να απενεργοποιηθεί, αλλά η μοναδικότητα των χρηστών σε πολλαπλά συστήματα χρηστών και παρόχους δεν διατηρείται πλέον τότε.",
    "Use provider identifier as prefix for IDs" : "Χρήση ταυτότητας παρόχου ως πρόθεμα για ταυτότητες",
    "To keep IDs in plain text, but also preserve uniqueness of them across multiple providers, a prefix with the providers name is added." : "Για να διατηρηθούν οι ταυτότητες σε απλό κείμενο, αλλά και να διατηρηθεί η μοναδικότητά τους σε πολλαπλούς παρόχους, προστίθεται ένα πρόθεμα με το όνομα του παρόχου.",
    ...
    "Do you want to allow API calls and WebDAV requests that are authenticated with an OIDC ID token or access token?" : "Θέλετε να επιτρέψετε κλήσεις API και αιτήματα WebDAV που πιστοποιούνται με OIDC ID token ή token πρόσβασης;",
    ...
    "This automatically provisions the user, when sending API and WebDAV requests with a Bearer token. Auto provisioning and Bearer token check have to be activated for this to work." : "Αυτό παρέχει αυτόματα τον χρήστη, κατά την αποστολή αιτημάτων API και WebDAV με Bearer token. Η αυτόματη παροχή και ο έλεγχος Bearer token πρέπει να είναι ενεργοποιημένα για να λειτουργήσει αυτό.",
    "Send ID token hint on logout" : "Αποστολή διακριτικού ID hint κατά την αποσύνδεση",
    ...
    "This will create and update the users groups depending on the groups claim in the ID token. The Format of the groups claim value should be {sample1}, {sample2} or {sample3}" : "Αυτό θα δημιουργήσει και θα ενημερώσει τις ομάδες χρηστών ανάλογα με το claim ομάδων στο διακριτικό ID. Η μορφή της τιμής του claim ομάδων πρέπει να είναι {sample1}, {sample2} ή {sample3}",
