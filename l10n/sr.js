OC.L10N.register(
    ...
    "This is needed if you are using other apps that want to use user_oidc's token exchange or simply get the login token" : "Ово је потребно ако користите остале апликације које желе да користе user_oidc размену жетона, или просто хоћете да преузмете жетон за пријаву",
