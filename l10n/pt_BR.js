OC.L10N.register(
    ...
    "The received state has expired." : "O estado recebido expirou.",
    ...
    "OpenID Connect user backend" : "Back-end de usuário de OpenID Connect",
    ...
    "Keep in mind that disabling \"Unique user IDs\" means that this provider can produce user IDs that are identical to user IDs from other providers (and from other user backends if you are in non-auto-provisioning mode). This means this provider can be potentially used to authenticate as users from other providers/backends. This might be what you want to achieve. In any case, please make sure you trust this provider." : "Tenha em mente que desativar \"ID de usuário único\" significa que esse provedor pode produzir IDs de usuário idênticas às IDs de usuário de outros provedores (e de outros back-ends de usuário, se você estiver no modo de provisionamento não automático). Isso significa que esse provedor pode ser potencialmente usado para autenticar usuários de outros provedores/back-ends. Talvez seja isso que você deseja. De qualquer forma, certifique-se de que confia nesse provedor.",
