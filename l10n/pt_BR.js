OC.L10N.register(
    ...
    "The authorized party does not match ours" : "A parte autorizada não corresponde à nossa",
    "No authorized party" : "Nenhuma parte autorizada",
    "The nonce does not match" : "O nonce não corresponde",
    ...
    "Failed to contact the OIDC provider token endpoint" : "Falha ao entrar em contato com o recurso de token do provedor OIDC.",
    "The issuer does not match the one from the discovery endpoint" : "O emissor não corresponde ao do recurso de descoberta",
    "Failed to provision the user" : "Falha ao provisionar o usuário",
    "You do not have permission to log in to this instance. If you think this is an error, please contact an administrator." : "Você não tem permissão para fazer login nesta instância. Se achar que isso é um erro, entre em contato com um administrador.",
    ...
    "Could not save storeLoginToken state: {msg}" : "Não foi possível salvar o estado do storeLoginToken: {msg}",
    ...
    "This is needed if you are using other apps that want to use user_oidc's token exchange or simply get the login token" : "Isso é necessário se você estiver usando outros aplicativos que desejam usar a troca de token do user_oidc ou simplesmente obter o token de login",
    ...
    "Discovery endpoint" : "Recurso de descoberta",
    "Backchannel Logout URL" : "URL de Logout do Backchannel",
    "Redirect URI (to be authorized in the provider client configuration)" : "URI de redirecionamento (a ser autorizado na configuração do cliente do provedor)",
    "Update" : "Atualizar",
    "Remove" : "Remover",
    ...
    "Custom end session endpoint" : "Recurso personalizado de fim de sessão",
    "Scope" : "Alcance",
