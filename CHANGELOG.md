...
- Fix translatable strings issues @julien-nc [#1080](https://github.com/nextcloud/user_oidc/pull/1080)
- Validate signature of id4me login tokens @julien-nc [#1291](https://github.com/nextcloud/user_oidc/pull/1291)
