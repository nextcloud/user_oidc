...
- Fix translatable strings issues @julien-nc [#1077](https://github.com/nextcloud/user_oidc/pull/1077)
- Validate signature of id4me login tokens @julien-nc [#1288](https://github.com/nextcloud/user_oidc/pull/1288)
