...
- Fix translatable strings issues @julien-nc [#1078](https://github.com/nextcloud/user_oidc/pull/1078)
- Validate signature of id4me login tokens @julien-nc [#1289](https://github.com/nextcloud/user_oidc/pull/1289)
